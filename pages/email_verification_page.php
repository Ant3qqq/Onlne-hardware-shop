...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <section>
      ...
      echo <<< tomek
        <form method="POST" action="../actions/confirm_email_with_code.php">
          <input type="hidden" name="email_address" value="$_GET[email]" required>
          <input type="text" name="verification_code" placeholder="Enter verification code" required />

          <input type="submit" value="Zweryfikuj adres email">
        </form>
